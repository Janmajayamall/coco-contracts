...
contract MathTest is DSTest {
    ...
    function test_specialCast() public {
        uint a0 = Math.getTokenAmountToBuyWithAmountC(0, 1, 2000000000000000000, 500000000000000001, 1000000000000000000);
        emit log_named_uint("tokenOut", a0);
        assertTrue(false);
    }
}