...
DEPLOYER=0xed53fa304E7fcbab4E8aCB184F5FC6F69Ed54fF6
Oracle=0xc227040739b85272e4d8231664dcfd7cb15f35f7
...
# create a new market
estimate=$(seth estimate $MarketRouter "createFundBetOnMarket(bytes32,address,uint256,uint256,uint256)" $(seth --to-bytes32 $(seth --to-hex '122111212')) $Oracle $(seth --to-wei 1 eth) $(seth --to-wei 1 eth) 1)
