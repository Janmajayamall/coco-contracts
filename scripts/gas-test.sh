...
MarketRouter=0xDA03ff10595eb342Bf54E719d1d528F95AeC6ADA
...
# create a new market
estimate=$(seth estimate $MarketRouter "createFundBetOnMarket(bytes32,address,uint256,uint256,uint256)" $(seth --to-bytes32 $(seth --to-hex '121')) $Oracle $(seth --to-wei 1 eth) $(seth --to-wei 1 eth) 1)
